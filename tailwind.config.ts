	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(200 100% 50% / 0.3), 0 0 40px hsl(200 100% 50% / 0.1)' 
					},
					'50%': { 
						boxShadow: '0 0 40px hsl(200 100% 50% / 0.6), 0 0 80px hsl(200 100% 50% / 0.3)' 
					}
				},
				'float': {
				...
				'logo-glow-pulse': {
					'0%, 100%': { filter: 'drop-shadow(0 0 30px hsl(263 70% 50% / 0.3)) drop-shadow(0 0 60px hsl(263 70% 50% / 0.15))' },
					'50%': { filter: 'drop-shadow(0 0 50px hsl(263 70% 50% / 0.5)) drop-shadow(0 0 100px hsl(263 70% 50% / 0.25))' }
				}
			},
			animation: {
