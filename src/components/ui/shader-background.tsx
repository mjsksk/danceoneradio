...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      // --background: 220 25% 5% -> RGB(10, 11, 16)
      vec4 bgColor1 = vec4(0.039, 0.043, 0.063, 1.0);
      // Blend toward --electric-purple: 270 100% 60% with low lightness
      vec4 bgColor2 = vec4(0.1, 0.04, 0.18, 1.0);
