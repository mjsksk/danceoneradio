        ...
        {hasVideos && (
          <div className="flex gap-2 px-6 pt-4">
            <button
              ...
              className={`w-14 h-14 rounded-md overflow-hidden border-2 transition-colors ${activeView === 'image' ? 'border-primary' : 'border-transparent hover:border-primary/40'}`}
            >
              {item.image ? (
            ...
            {item.videos!.map((_, idx) => (
              <button
                ...
                className={`w-14 h-14 rounded-md overflow-hidden border-2 transition-colors bg-muted flex items-center justify-center ${activeView === idx ? 'border-primary' : 'border-transparent hover:border-primary/40'}`}
              >
