...
const Episode412 = lazy(() => import('@/pages/Episode412'));
const Episode413 = lazy(() => import('@/pages/Episode413'));
const Episode414 = lazy(() => import('@/pages/Episode414'));
const Episode415 = lazy(() => import('@/pages/Episode415'));
const Episode416 = lazy(() => import('@/pages/Episode416'));
const Episode417 = lazy(() => import('@/pages/Episode417'));
...
const Episode422 = lazy(() => import('@/pages/Episode422'));
const Episode423 = lazy(() => import('@/pages/Episode423'));
const Episode424 = lazy(() => import('@/pages/Episode424'));
const Episode425 = lazy(() => import('@/pages/Episode425'));
...
const Wh0PlaysSession233 = lazy(() => import('@/pages/Wh0PlaysSession233'));
const Wh0PlaysSession235 = lazy(() => import('@/pages/Wh0PlaysSession235'));
const Wh0PlaysSession236 = lazy(() => import('@/pages/Wh0PlaysSession236'));
const Wh0PlaysSession238 = lazy(() => import('@/pages/Wh0PlaysSession238'));
const Wh0PlaysSession239 = lazy(() => import('@/pages/Wh0PlaysSession239'));
...
const Wh0PlaysSession246 = lazy(() => import('@/pages/Wh0PlaysSession246'));
...
const HouseVsTechHouseVsTechno = lazy(() => import('@/pages/HouseVsTechHouseVsTechno'));
  ...
  return (
    ...
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/episode/412" element={<PageTransition><Episode412 /></PageTransition>} />
        <Route path="/episode/413" element={<PageTransition><Episode413 /></PageTransition>} />
        <Route path="/episode/414" element={<PageTransition><Episode414 /></PageTransition>} />
        <Route path="/episode/415" element={<PageTransition><Episode415 /></PageTransition>} />
        <Route path="/episode/416" element={<PageTransition><Episode416 /></PageTransition>} />
        <Route path="/episode/417" element={<PageTransition><Episode417 /></PageTransition>} />
        ...
        <Route path="/episode/422" element={<PageTransition><Episode422 /></PageTransition>} />
<Route path="/episode/423" element={<PageTransition><Episode423 /></PageTransition>} />
        <Route path="/episode/424" element={<PageTransition><Episode424 /></PageTransition>} />
        <Route path="/episode/425" element={<PageTransition><Episode425 /></PageTransition>} />
        ...
        <Route path="/show/wh0-plays-sessions/238" element={<PageTransition><Wh0PlaysSession238 /></PageTransition>} />
        <Route path="/show/wh0-plays-sessions/239" element={<PageTransition><Wh0PlaysSession239 /></PageTransition>} />
        <Route path="/show/wh0-plays-sessions/240" element={<PageTransition><Wh0PlaysSession240 /></PageTransition>} />
        <Route path="/show/wh0-plays-sessions/241" element={<PageTransition><Wh0PlaysSession241 /></PageTransition>} />
...
<Route path="/show/wh0-plays-sessions/245" element={<PageTransition><Wh0PlaysSession245 /></PageTransition>} />
        <Route path="/show/wh0-plays-sessions/246" element={<PageTransition><Wh0PlaysSession246 /></PageTransition>} />
        ...
        <Route path="/news/house-vs-tech-house-vs-techno" element={<PageTransition><HouseVsTechHouseVsTechno /></PageTransition>} />
