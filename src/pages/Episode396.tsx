...
const Episode396 = () => {
  ...
  const episodeTitle = "Future Dance Anthems with Mario - Episode 396";
  const audioUrl = "https://media.blubrry.com/future_dance_anthems/content.blubrry.com/future_dance_anthems/FDAM_Ep396.mp3";
