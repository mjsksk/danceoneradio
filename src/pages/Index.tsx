  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      <div className="relative z-10 flex flex-col min-h-screen">
        <SEO
          title="Live Dance Radio Station — Electronic Music Streaming 24/7 | Dance One"
          description="Stream live dance radio and electronic music 24/7 — house, trance, techno and EDM mixes, weekly DJ shows and full episode tracklists."
