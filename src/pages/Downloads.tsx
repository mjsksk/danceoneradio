...
const Downloads = () => {
  const downloadUrl = 'https://github.com/mjsksk/danceoneradio/releases/download/v1.0.20/dance-one-radio-setup-1.0.20-x64.exe';

  const handleDownload = () => {
    supabase
      .from('app_downloads')
      .insert({ platform: 'windows', version: '1.0.20' })
      .then(() => {});
              ...
              <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-8 text-center">
                <div className="relative z-10">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground">
                    Version 1.0.20 • Windows 10+ (64-bit) • Free
                  </div>
                </div>
              </div>
            </div>
